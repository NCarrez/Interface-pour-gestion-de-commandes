...
int UART_receive(char receive_tab[], int num) {
	int32_t err;
	int i;
	while(Driver_USART6.GetStatus().rx_busy==1); 
	err = Driver_USART6.Receive(receive_tab,num);
